...
function updateComponent(opts) {
    const { doCreateComponent, doCreateFunctionalComponent, doCreateClassComponent, name, componentSource, functionalComponentSample, classComponentSample, } = opts;
    ...
    const { isFunctionalComponent, isClassComponent, beforeComponent, afterComponent, name: origName, } = parsed;
